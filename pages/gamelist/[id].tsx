  ...
  return (
    <div className="w-full flex flex-col items-center py-8 px-4 space-y-6">
      <div className="w-fit flex items-center space-x-4 ">
        <p className="text-5xl underline">Game Information</p>
        <p className=" p-4 text-blood text-5xl rounded-md bg-sun">Valorant</p>
      </div>
      <div className="w-full flex space-x-2">
        <div className="w-1/2 flex flex-col space-y-2">
          <p className="underline">Game Play</p>
          <div className="w-full h-96 p-2 bg-grass rounded-md"></div>
        </div>
        <div className="w-1/2 flex flex-col space-y-2">
          ...
          <div className="w-full flex flex-col">
            ...
            <div className="p-2 space-y-4 bg-white bg-opacity-50 rounded-b-md">
              ...
              <p className="text-blood">
                Storage{" "}
                <span className="text-black">15 GB available space</span>
              </p>
              <p className="text-blood">
                Sound Card{" "}
                <span className="text-black">DirectX Compatible</span>
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="w-full flex flex-col space-y-2">
        <p className="underline">ABOUT THIS GAME</p>
